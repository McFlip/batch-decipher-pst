  ...
  return(
    <div className='container'>
      ...
      <main>
        ...
        { serialsProp.length < 1 ? <div className='alert alert-danger'>WARNING: no keys are loaded for this case!</div> : '' }
        ...
        <hr/>
        <h2>Launch Script</h2>
        <button className='btn btn-primary' disabled={serialsProp.length < 1 || isRunning} onClick={() => handleRun()}>
          { isRunning ?

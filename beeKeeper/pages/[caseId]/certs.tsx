...
export const getServerSideProps: GetServerSideProps = async (context) => {
  ...
  const urlCerts = `http://queenbee:3000/sigs/${caseId}`
  try {
  ...
  return(
    <div className='container'>
      ...
      <main>
        ...
        <h2>Launch Script</h2>
        <button className='btn btn-primary' disabled={isRunning} onClick={(e: MouseEvent<HTMLButtonElement>) => handleRun(caseId)}>
          { isRunning ?

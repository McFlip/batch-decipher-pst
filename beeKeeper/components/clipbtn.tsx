...
export default function ClipBtn (props: propsType) {
  const { txtToCopy } = props
  return(
    <button className='btn btn-secondary' onClick={() => navigator.clipboard.writeText(txtToCopy)}>
